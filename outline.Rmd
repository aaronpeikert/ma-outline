...
2. How do perform resampling/cross-validation strategies under the same conditions with regard to precision and unbiasdness?
3. How do perform information-criteria vs. crossvalidation under suboptimal conditions (not meeting assumptions of the information criteria)?
4. What information does the mixing parameter carry? Is the inconsistency of the AIC a problem?
5. Is the the model selection uncertanty different for the two models? Does it influence the results? Can it be fixed?
